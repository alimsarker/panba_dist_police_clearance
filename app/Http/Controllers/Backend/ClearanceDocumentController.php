...
class ClearanceDocumentController extends Controller
{
 ...
 public function StoreDataClearance(Request $request){
    ...
    $this->validate($request,[
        'mobile_no' => 'required|unique:clearance_documents',
...
//   $sms = AssignOfficerName::with('assign_officer')->where('assign_officer_cell',$request->assign_officer_cell)->get();
    // dd($sms);
...
$message = "আপনার উপর একটি পুলিশ ক্লিয়ারেন্স (Ref No: $request->ref_no) এর দায়িত্ব দেওয়া হয়েছে, থানা হতে সংগ্রহ করুন।";
