...
<!-- Basic Forms -->
 ...
 <div class="box">
   <div class="box-header with-border">
     <h4 class="box-title">Clearance Applicant data edit</h4>
   ...
   <div class="box-body">
     <div class="row">
       <div class="col">
           <form method="post" action="{{ route('clearance.data.update',$editData->id) }}">@csrf
             <div class="row">
                    <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <select name="ps_name_id" id="ps_name_id" required="" class="form-control">
                                    ...
                                    <option value="{{ $ps->id }}"  {{ ($editData->ps_name_id == $ps->id)? "selected":""}}  >{{ $ps->ps_name }}</option>
                                    @endforeach	
                                </select>
                        ...
                        <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                    <input type="text" name="applicant_name" class="form-control" required="" value="{{ $editData->applicant_name }}"> </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <input type="text" name="father_name" class="form-control" required="" value="{{ $editData->father_name }}"> </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <input type="text" name="spouse" class="form-control" required=""  value="{{ $editData->spouse }}"> </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                    <input type="text" name="mobile_no" class="form-control" required="" value="{{ $editData->mobile_no }}" > </div>
                                </div>
                        </div>
                        <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                    <input type="text" name="village_road_no" class="form-control" required=""  value="{{ $editData->village_road_no }}"> </div>
                                </div>
                        </div>
                    </div>
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <input type="text" name="post_post_code" class="form-control" required=""  value="{{ $editData->post_post_code }}"> </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <input type="text" name="upazilla" class="form-control" required=""  value="{{ $editData->upazilla }}"> </div>
                            </div>
                        ...
                        <div class="form-group">
                                ...
                                <div class="controls">
                                <input type="text" name="dist" class="form-control" required=""  value="{{ $editData->dist }}"> </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <input type="text" name="ref_no" class="form-control" required=""  value="{{ $editData->ref_no }}"> </div>
                            </div>
                        </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                    <input type="date" name="apply_date" class="form-control"  value="{{ $editData->apply_date }}" > </div>
                                </div>
                        </div>
                        ...
                        <!-- <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                    <input type="text" name="entry_by_ps_person" class="form-control" required="" value="{{ $editData->entry_by_ps_person }}"> </div>
                                </div>
                        </div> -->
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <input type="text" name="entry_person_mobile" class="form-control" required="" value="{{ $editData->entry_person_mobile }}"> </div>
                            </div>
