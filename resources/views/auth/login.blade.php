...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('backend/app-assets/images/favicon/police-152x152.jpg') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('backend/app-assets/images/favicon/police32.jpg') }}">
